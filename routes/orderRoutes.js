...
module.exports = (app, upload) => {
    ...
    app.post('/api/orders/create',   passport.authenticate('jwt', {session: false}), upload.array('image', 1), OrdersController.create);
    
    app.put('/api/orders/updateToPay', passport.authenticate('jwt', {session: false}), OrdersController.updateToPay);
